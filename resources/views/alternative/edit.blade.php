        ...
        <form action="{{ route('alternative.update', $alternative->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <select class="form-control @error('jenis_kelamin') is-invalid @enderror"
                    ...
                    <option value="Laki-laki" {{ in_array(old('jenis_kelamin', $alternative->jenis_kelamin), ['Laki-laki', 'L']) ? 'selected' : '' }}>Laki-laki</option>
                    <option value="Perempuan" {{ in_array(old('jenis_kelamin', $alternative->jenis_kelamin), ['Perempuan', 'P']) ? 'selected' : '' }}>Perempuan</option>
                </select>
                @error('jenis_kelamin')
                    <div class="invalid-feedback">
                        {{ $message }}
            ...
            <div class="mb-3">
                ...
                <input type="number"
                       ...
                       id="lama_bekerja"
                       name="lama_bekerja"
                       value="{{ old('lama_bekerja', $alternative->lama_bekerja) }}"
                       min="0"
                       required>
                @error('lama_bekerja')
                    <div class="invalid-feedback">
